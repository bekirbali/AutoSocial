# AutoSocial — Learning Proposal

Eski konuşmadan (`2de44249-...`) çıkarılan tüm kararlar ve konfigürasyonlar aşağıda.
Bunlar `AutoSocial` projesine özel kalıcı bir **Kural (Rule)** olarak kaydedilecek.

---

## Sınıflandırma

**Tür:** Rule (Kural) — Proje bağlamı, teknik kararlar ve sabit kısıtlar  
**Kapsam:** AutoSocial workspace (`c:/Users/Bekir/Desktop/software/AutoSocial`)  
**Hedef Dosya:** `.agents/rules/autosocial-context.md` (workspace-level rule)

---

## Kaydedilecek İçerik (Diff)
...
+ ❌ Unsplash API — çıkarıldı
+ ❌ Pexels API — çıkarıldı
+
...
+ - Min skor eşiği: 60/100 (freshness %40 + keyword %30 + kaynak %20 + kalite %10)
```
...
`c:\Users\Bekir\Desktop\software\AutoSocial\.agents\rules\autosocial-context.md`

Bu dosya workspace-level rule olarak her AutoSocial konuşmasında otomatik yüklenir.

---

> **Onaylıyor musun?** Onaylarsan dosyayı oluşturup kalıcı olarak kaydederim.
